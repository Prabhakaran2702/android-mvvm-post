...
public class FragmentFavouritesBindingImpl extends FragmentFavouritesBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.justclean_mvvm_post.ui.favourites.FavouritesViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.example.justclean_mvvm_post.ui.favourites.FavouritesViewModel Viewmodel) {
